...
class Saaya_Social_Media extends WP_widget {
    ...
    public function __construct() {
        $widget_ops = array( 
            'classname' => 'saaya_social_media',
            'description' => __( 'A widget shows the social media icons.', 'saaya' )
        );
        parent::__construct( 'saaya_social_media', __( 'MT: Social Media', 'saaya' ), $widget_ops );
    }
