...
$post_content_type = apply_filters( 'saaya_archive_post_content_type', 'excerpt' );
			...
			if ( 'excerpt' === $post_content_type ) {
				...
				the_content( sprintf(
					wp_kses(
						...
						__( 'Continue reading<span class="screen-reader-text"> "%s"</span>', 'saaya' ),
						array(
							'span' => array(
								'class' => array(),
							),
